...
#    "genres": ["Jazz", "Reggae", "Swing", "Classical", "Folk"],        x    ??
#    "address": "1015 Folsom Street",
#    "city": "San Francisco",
#    "state": "CA",
#    "phone": "123-123-1234",
#    "website": "https://www.themusicalhop.com",                        x
#    "facebook_link": "https://www.facebook.com/TheMusicalHop",
#    "seeking_talent": True,                                            x
#    "seeking_description": "We are on the lookout for a local artist to play every two weeks. Please call us.",          x
...
#venue creation form, they are not using Ajax or any javascript, so we will catch it as a dictionary:
...
def show_artist(artist_id):
  ...
  #-#-#-#data = list(filter(lambda d: d['id'] == artist_id, [my_dict, data1, data2, data3] ))[0]     # with
...
def shows():
  ...
  print ('WTTTTTTTTTFFFFFFFFFFFFFF')
  artist_id = 1
  shows = db.session.query(Show).join(Artist.shows).filter(Artist.id == artist_id).all()
  #print('show is shows', shows.artist)
  #print()
  ...
  for show in shows:
      temp_show = {
          ...
          #'show_id': show.id,
          #'show_venueid': show.venue_id,
          #'show_starttime': show.start_time
          'venue_id': show.venue_id,
          'venue_name': show.venue.name,
          'artist_genres': show.artist.genres,
          'venue_genres': show.venue.genres
          ###
          ###
      }
  
  
      print('lololololo',temp_show)
